...
/**
 * Identidade de usuário inativo — credencial válida, acesso negado (403).
 *
 * Sem estado: usa padrão singleton para evitar alocações desnecessárias.
 * O middleware verifica instanceof para distinguir de null (401) e de AuthIdentity (200).
 */
final class InactiveAuthIdentity implements AuthIdentityInterface
{
    ...
    public function type(): string                  { return 'inactive'; }
